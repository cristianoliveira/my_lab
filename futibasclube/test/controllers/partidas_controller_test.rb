...
class PartidasControllerTest < ActionController::TestCase
  ...
  test "should create partida" do
    assert_difference('Partida.count') do
      post :create, partida: { descricao: @partida.descricao, dia_semana: @partida.dia_semana, tipo: @partida.tipo, usuario_id: @partida.usuario_id }
    end
  ...
  test "should update partida" do
    patch :update, id: @partida, partida: { descricao: @partida.descricao, dia_semana: @partida.dia_semana, tipo: @partida.tipo, usuario_id: @partida.usuario_id }
    assert_redirected_to partida_path(assigns(:partida))
  end
