...
<div class="conteudo interna">
	<div class="container">
        ...
        <h1>Alterar Meu Cadastro</h1>
        
        <div class="voltar"><a href="<?php echo $anterior ?>">&#171; VOLTAR</a></div>
        
        <p class="titulo-interna">No formulário abaixo você pode alterar seu endereço de cadastro.</p>
        
        <div class="navegue-forms">
        	<a href="<?php echo SITE_URL ?>/area-cliente/alterar-meus-dados" title="Clique para visualizar o formulário dos dados cadastrais"><img src="<?php echo SITE_BASE ?>/views/imagens/form-dados-cadastrais.gif" alt="Formulário dos Dados Cadastrais" /></a>
        ...
        <form method="post" action="<?php echo SITE_URL ?>/area-cliente/alterar-endereco/#form_cadastro_notification" id="form-endereco" >
