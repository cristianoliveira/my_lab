...
$query = sprintf("SELECT * FROM banners WHERE codigo = %d", $_GET['id']);
                ...
                <form action="acao.php?a=2&id=<?php  echo $_GET['id']; ?>" id="banners_form" method="post" enctype="multipart/form-data">	
					...
					<fieldset>
                        ...
                        <p>
                            ...
                            <input class="text-input small-input required" type="text" id="nome" name="nome" maxlength="150" value="<?php  echo $manda['nome']; ?>"/>
                        </p>
                        <p>
					    <label for="link">Link</label>
							<input class="text-input large-input"id="link"name="link"maxlength="255" value="<?php  echo $manda['link']; ?>"/>
...
<?php  } ?>
                        ...
                        <p>
						  ...
						  <input class="text-input" type="file" name="imagemnova" id="imagemnova" value=""/><br />
	                        <small>Edite a imagem na Ferramenta Crop, clique aqui para editar a imagem.<strong></strong></small>
													</p>
