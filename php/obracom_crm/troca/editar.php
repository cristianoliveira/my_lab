...
$query = sprintf("SELECT * FROM imoveis WHERE idimoveis = %d", $_GET['id']);
...
<body class="destaques formulario">
	...
	<div id="main-content"> <!-- Main Content Section with everything -->
        ...
        <!-- Page Head -->
			...
			<p id="page-intro">Aqui você pode editar o conteúdo da página Troca de Óleo.</p>
					...
					<fieldset>
					  <p>
                        <label for="descricao">Texto</label>
                            <textarea class="text-input textarea wysiwyg required" id="descricao" name="descricao" cols="79" rows="15"><?php  echo $manda['descricao']; ?></textarea>
                         
                            <small> Até 512 caracteres. </small>
                        </p>
                      <?php  if (isset($manda['imagem'])) { ?>
    
    <p>
							<label for="imagematual">Imagem Atual</label>
                         	<a id="example1" href="../uploads/imoveis/<?php  echo $manda['imagem']; ?>">&raquo; Clique aqui para visualizar</a>
                            <input type="hidden" value="<?php  echo $manda['imagem']; ?>" name="imagematual" />
                          <br />
...
<?php  } ?>
                        ...
                        <p>
						  ...
						  <small>Esta imagem será usada nas listagens de imóvies e deverá ter um tamanho máximo de 306x425 pixels, não ultrapassando os 1mb.</small></p>
