...
<div class="conteudo">
	<div class="container">
        ...
        <div class="detalhes">
            ...
            <div class="imagem">
            	<a class="colorbox-produto" title="<?php echo $produto->get_codigo().' '.$produto->get_nome() ?>" href="<?php echo SITE_BASE.'/arquivos/produtos/'.$produto->get_imagem() ?>"><img src="<?php echo SITE_BASE.'/arquivos/produtos/thumb1/'.$produto->get_imagem() ?>" alt="<?php echo $produto->get_codigo().' '.$produto->get_nome() ?>" /> </a> 
	            ...
	            {
		            echo '<p>Mais fotos deste produto</p>';
					echo '<ul>';
		            foreach ($produto_imagens as $imagem)
		            {
			            echo '<li><a class="colorbox-produto" title="'.$imagem->get_titulo().'" href="'.SITE_BASE.'/arquivos/produtos/'.$imagem->get_imagem().'"><img src="'.SITE_BASE.'/arquivos/produtos/thumb3/'.$imagem->get_imagem().'" alt="'.$imagem->get_titulo().'" /></a></li>';
		            }
	                echo '</ul>';
	            }
				?>
