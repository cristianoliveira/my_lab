...
<head>
    ...
    <title>Primous Soluções Inteligentes - Web Inteligente</title>
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">
                    ...
                    <h5>Primous Soluções Inteligentes</h5>
                </a>
            </div>
            ...
            <div class="intro-text">
                <div id="slides">
                    <div class="slides_container">
                        <div class="slide">
                            <div class="slide-center-slice">
                                <h2>Soluções Inteligentes</h2>
                                <img id="imagem-principal" src="imagens/software/cima_box.png" />
                            </div>
                        </div>
                        <div class="slide">
                            <div class="slide-left-slice">
                                <h2>Soluções para Web</h2>
                            ...
                            <div class="slide-right-slice">
                                <img src="imagens/software/site_300_259.png" />
                                <p><a href="produto#web" >Veja mais sobre a solução completa.</a></p>
                            </div>
                        </div>
                        <div class="slide">
                            <div class="slide-left-slice">
                                <img src="imagens/big-data-600-400.png" />
                            </div>
                            <div class="slide-left-slice">
                              <h2>Sua empresa conectada!</h2>
                               <p>A Primous possui serviços na web integrados a seus softwares. 
                                  Customize a maneira de se comunicar com seus clientes!
                                  Proporcionando dessa forma o diferencial ao seu negócio.
                                   <strong>Você mais conectado.</strong></p>
                                <p><a href="produto#integradas">Descubra as soluções integradas</a></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Desenvolvemos soluções sob medida.</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">Desenvolvimento de solução completa para gerênciamento de lojas virtuais. Para micro e pequenas empresas</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">Soluções inteligentes para web. Desenvolvimento completo ou integrações com sistemas já existentes.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">Coleta de Dados</h4>
                    <p class="text-muted">Fornecemos softwares inteligentes para coleta e armazenagem de dados.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Responderemos a qualquer dúvida.</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
