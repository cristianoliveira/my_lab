...
//######### FIM dados Paginação
        ...
        $sql = mysql_query("SELECT * FROM imagens_roteiros LIMIT $inicial, $numreg");

        // Serve para contar quantos registros você tem na sua tabela para fazer a paginação
        $sql_conta = mysql_query("SELECT * FROM imagens_roteiros");        
...
<table width=100% cellpading=0 cellspacing=0>
	...
	<div id="main-content"> <!-- Main Content Section with everything -->
		...
		<!-- Page Head -->
		<h2>Galeria de Imagens do Roteiro</h2>
		<br />
