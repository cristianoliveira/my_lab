...
<body class="destaques formulario">
	...
	<div id="main-content"> <!-- Main Content Section with everything -->
        ...
        <!-- Page Head -->
			...
			<div class="notification error png_bg"><a class="close" href="#"><img alt="fechar" title="Fechar esta notificação" src="../imagens/icones/cross_grey_small.png"/></a>
			<div> <strong> Você está editando um ROTEIRO PAUSADO. Para ele ir ao ar, por favor mude o STATUS. Importante lembrar que se não alterar as datas de início e fim ele não irá para o ar. A não ser que ele esteja como SEM DATA DETERMINADA.</strong></div></div>
			<?php  $_SESSION['ok']=""; } ?>
...
<?php  } ?>
                  ...
                  <p>                                              
  <a name="okok"></a>
<h2> Relacionar Países</h2><small> * Para remover os campos em específico, primeiro dê um ADICIONAR. Logo após Remova os desejados. Caso queira excluir todos, clique logo abaixo em Remover todos.</small><p></p>
...
<?php } ?>
<small> <a href="remover_pais.php?idr=<?php  echo $_GET["id"]; ?>"> (x) Remover todos países </a> </small>
...
?>
				  ...
				  <label>Data de Início</label>
			       ...
			       <select name="sem_data" id="sem_data">
                    <option value="0" <?php  if ($manda['sem_data'] == 0) { echo 'selected="selected"'; } ?>> Não </option>         
                   <option value="1"  <?php  if ($manda['sem_data'] == 1) { echo 'selected="selected"'; } ?>> Sim </option>
		            </select>
                    <small> *Este item serve para os roteiros sem datas definidas. </small>
		          </p> 
...
<br>
                  ...
                  <p>
			       ...
			       <input class="text-input small-input required" type="text" id="texto_destaque_home" name="texto_destaque_home" maxlength="20" value="<?php  echo $manda['texto_destaque_home']; ?>" /><br>
                   ...
                   <option value="1" <?php  if ($manda['destaque_home_roteiros'] == 1) { echo 'selected="selected"'; } ?>> Sim </option>
                    ...
                    <small> *Este item destaca o roteiro para a o meio do site. Embaixo das buscas. Caso marque esta opção e a de cima (Destaque Cabeçalho) aparecerá em ambos. </small>
		          </p>
