...
if(mysql_num_rows($sql)>0){
	?>
				<table>
					...
					<thead>
						<tr>
							<th class="current"><a href="#"class="down">Empresa</a></th>							<th class="current">&nbsp;</th>                            <th class="current">Ações</th>
						</tr>
					</thead>
...
?>
														...
														<tr>
									<td>
										<a href="editar.php?id=<?php echo $row['idempresa']; ?>" title=""> Clique aqui para atualizar o conteúdo da empresa </a>
                                    </td>
									<td class="">&nbsp;</td>
                                    <td>
										<!-- Icons -->
					<a href="editar.php?id=<?php echo $row['idempresa']; ?>" title="Editar a notícia.">
                    <img src="../imagens/icones/pencil.png" alt="Editar" />
                    </a>
                    
                    <a href="galeria.php?id=<?php echo $row['idempresa']; ?>" title="Editar as fotos da notícia.">
                    <img src="../imagens/galeria.gif" alt="Galeria" />
                    </a>
                    
                    <a href="editar.php?id=<?php echo $row['idempresa']; ?>"title="Editar a notícia."></a>
