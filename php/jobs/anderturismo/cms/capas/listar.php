...
//######### FIM dados Paginação
        ...
        $sql = mysql_query("SELECT * FROM capa_roteiros LIMIT $inicial, $numreg");

        // Serve para contar quantos registros você tem na sua tabela para fazer a paginação
        $sql_conta = mysql_query("SELECT * FROM capa_roteiros");        
...
<table width=100% cellpading=0 cellspacing=0>
	...
	<div id="main-content"> <!-- Main Content Section with everything -->
		...
		<!-- Page Head -->
		<h2>Lista de Capas cadastradas</h2>
		<p id="page-intro">Abaixo estão listados todas as capas que são exibidas no PDF de cada roteiro.</p>
  ...
  <div class="content-box"><!-- Start Content Box -->
			...
			<div class="content-box-header">
				...
				<h3>Capas de Roteiros</h3>
			  <input class="destaques button botao-cadastrar" type="button" value="Cadastrar uma capa"  onclick="javascript: location.href='cadastro.php?p=5&g=1';"  />
			  <div class="clear"></div>
			...
			<div class="content-box-content">
				...
				<table>
					...
					<thead>
						<tr>
							<th class="current"><a href="#"class="down">Nome da Capa</a></th>
...
?>
														...
														<tr colspan="2">
									<td>
										<a href="#" title=""> <?php echo $row['nome_capa'] ; ?> </a>
                                    </td>
                                    <td>
										<!-- Icons -->
										<a href="editar.php?id=<?php echo $row['idcapas']; ?>"title="Editar o banner.">
											<img src="../imagens/icones/pencil.png"alt="Editar"/>
										</a>
										<a href="acao.php?a=3&id=<?php echo $row['idcapas']; ?>" title="Excluir o banner." class="item-confirmar"  onclick="if(!confirm('Você tem certeza que deseja excluir essa capa?')) return false;">
