...
function get_feed_data(){ 
	...
	$app_id = '1480888345513954';
	$app_secret = 'f091c62ea534efce25aff582b1b7d6db';
	$access_token = false;
	...
	//$access_token = "1480888345513954|ApIZ_guJifUcyFybq_5jPE6DdMU";
	
	
	//save the app token to a file for later use
	$ourFileName = "fb_app_token.php";
