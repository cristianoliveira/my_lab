...
$Email->AddAddress('contato@andesturismo.com.br'); //junior@obrcom.com.br
$Email->AddCC('mailsclientesdaobra@gmail.com'); //mailsclientesdaobra@gmail.com
$Email->AddBCC($email); //atendimento@anaizolanadvocacia.com.br
...
echo "Erro: " . $Email->ErrorInfo;
	...
	echo "<meta http-equiv='refresh' content='0; url=index.php?r=2'>";
	}
//###########################################################
