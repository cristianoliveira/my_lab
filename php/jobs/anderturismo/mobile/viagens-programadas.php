...
<html>
  <head>
    ...
    <title>Viagens Programadas - Andes Turismo</title><!-- Define o título da página -->
...
<body>
  ...
  <!-- /////// DIV CABEÇALHO //////// -->
    <div class="cabecalho container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Viagens Programadas</li>
      </ol>
      <!-- FIM BREADCRUMB -->
      <!-- TÍTULO PÁGINA -->
  ...
  <div class="conteudoMeio container">
      ...
      <!-- CONTEÚDO PÁGINA -->
        ...
        <?php } else{ echo "<p>Não há roteiros programados cadastrados no momento.</p>"; } ?><br/>
