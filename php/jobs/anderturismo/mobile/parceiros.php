...
<html>
  <head>
    ...
    <title>Parceiros - Andes Turismo</title><!-- Define o título da página -->
...
<body>
  ...
  <!-- /////// DIV CABEÇALHO //////// -->
    <div class="cabecalho container">
      ...
      <div class="page-header">
        <h2>Parceiros <small>Seja um deles</small></h2>
      </div>
      <!-- FIM TÍTULO PÁGINA -->
  </div>
  <!-- /////// FIM DIV CABEÇALHO //////// -->
  ...
  <div class="conteudoMeio container">
      <!-- CONTEÚDO PÁGINA -->
        <ul id="lista-parceiros" class="list-group">
            <li class="list-group-item col-xs-3">
                <img src="imagens/img_parceiro.jpg" alt="Âncora" title="Âncora" />
                <h6>Âncora</h6>
            </li>
            <li class="list-group-item col-xs-3">
                <img src="imagens/img_parceiro.jpg" alt="Âncora" title="Âncora" />
