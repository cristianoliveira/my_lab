...
$roteiros_meio = "SELECT * FROM `roteiros` WHERE status_roteiro=1 AND viagens_programadas=1 AND data_inicio >= $data_atual ORDER BY data_fim";
...
<html>
  <head>
    ...
    <title>Viagens Individuais - Andes Turismo</title><!-- Define o título da página -->
...
<body>
  ...
  <!-- /////// DIV CABEÇALHO //////// -->
    <div class="cabecalho container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Viagens Individuais</li>
      </ol>
      <!-- FIM BREADCRUMB -->
      <!-- TÍTULO PÁGINA -->
      <div class="page-header">
        <h2>Viagens Individuais</h2>
      </div>
      <!-- FIM TÍTULO PÁGINA -->
  </div>
  <!-- /////// FIM DIV CABEÇALHO //////// -->
  ...
  <div class="conteudoMeio container">
      ...
      <!-- CONTEÚDO PÁGINA -->
        ...
        <?php } else{ echo "<p>Não há roteiros individuais cadastrados no momento.</p>"; } ?><br/>
