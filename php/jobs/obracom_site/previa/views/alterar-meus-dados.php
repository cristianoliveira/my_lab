...
<div class="conteudo interna">
	<div class="container">
        ...
        <p class="titulo-interna">No formulário abaixo você pode alterar seus dados de cadastro.</p>
        ...
        <form method="post" action="<?php echo SITE_URL ?>/area-cliente/alterar-meus-dados/#form_cadastro_notification" id="form-dados-cadastrais" class="form-alterar-dados-cadastrais">
