...
class Controller_SegurancaCompra extends Controller_Padrao
{
	/**
	...
	public function index($parametros)
	{
        ...
        $view = new View('seguranca-compra.php');
		...
		$view->set_variavel('body_class', 'seguranca-compra');
		$view->set_variavel('notificacao', new Notificacao);

        $view->set_variavel('pagina_title', 'Segurança na Compra');
