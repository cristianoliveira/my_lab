...
class Model_ProdutoCor extends Model_Padrao
{
	protected $tabela_nome = 'produtos_cores';
	protected $colunas = array('id','produto_id','imagem','nome', 'cor');
	protected $colunas_not_null = array('id','produto_id');

	/* 4 propriedades */
	protected $id; // int unsigned not null
	protected $produto_id; // int unsigned not null
	protected $imagem; // varchar(36) not null
	protected $nome; // varchar(100)
	protected $cor; // varchar(20)
	...
	public function get_cor() {return $this->cor;}
	public function set_cor($string) {$this->cor = ! is_null($string) ? mb_substr(trim($string), 0, 20) : NULL;}
