...
class Model_CompraEndereco extends Model_Padrao
{
    protected $tabela_nome = 'compras_enderecos';
    protected $colunas = array('id','compra_id','endereco','numero','complemento','referencia',
        'bairro','cidade','estado','cep','tipo');
    protected $colunas_not_null = array('id','compra_id');

    /* 11 propriedades */
    protected $id; // int primary key not null
    protected $compra_id; // int primary key not null
