...
if ( ! function_exists('my_blog_url'))
{
	function my_blog_url($uri = '')
	{
		$CI =& get_instance();
		$site_url = $CI->config->slash_item('base_url');
        if ($uri<>'') $site_url = $site_url.'blog/'.$uri;
         else $site_url = $site_url.'/blog';
        return $site_url;
	}
}
// ------------------------------------------------------------------------
...
if ( ! function_exists('current_url'))
{
	...
	{
		$CI =& get_instance();
		return $CI->config->my_site_url($CI->uri->uri_string());
	}
}
...
{
	function my_auto_link($str, $type = 'both', $popup = FALSE)
	{
		if ($type != 'email')
		{
