...
<?php 
 ...
 $inserir = mysql_query("INSERT INTO downloads (img, id_imovel) VALUES ('$cod','$pegaId')");
 }else{
...
<form name="upload_files" action="" enctype="multipart/form-data" method="post">
 <input type="file" name="img[]" class="multi" maxlength="20" accept="jpeg|jpg|png|gif|pdf" />
 <input type="submit" name="upload" value="Upload" />
</form>

<?php
$seleciona = mysql_query("SELECT * FROM downloads WHERE id_imovel = $pegaId");
$contar = mysql_num_rows($seleciona);
if($contar <= '0'){
 echo "<br>Nenhum download cadastrado! Favor selecionar e fazer o upload.";
}else{
...
<div style="float:left; padding:20px;">
	<a href="../uploads/downloads/<?php echo $imagen; ?>" target="_blank" title="Ampliar para visualizar" > <img src="../imagens/pdf.png" alt="" style="padding-bottom:10px;"  /> </a>
 <br /> 
