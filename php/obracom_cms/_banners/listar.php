  ...
  <div class="content-box"><!-- Start Content Box -->
			...
			<div class="content-box-content">
				...
				<table>
					...
					<thead>
						<tr>
							<th class="current"><a href="#"class="down">Título</a></th>							<th class=""><a href="#"class="down">Descrição</a></th>                            <th>Ações</th>
						</tr>
					</thead>
...
?>
														...
														<tr>
									<td class="current">
										<a href="#" title=""> <?php echo $row['nome'] ; ?> </a>
                                    </td>
									<td class=""><?php echo $row['descricao'] ; ?> </td>
                                    <td>
										<!-- Icons -->
										<a href="editar.php?id=<?php echo $row['codigo']; ?>"title="Editar o banner.">
											<img src="../imagens/icones/pencil.png"alt="Editar"/>
										</a>
										<a href="acao.php?a=3&id=<?php echo $row['codigo']; ?>" title="Excluir o banner." class="item-confirmar"  onclick="if(!confirm('Você tem certeza que deseja excluir esse banner?')) return false;">
